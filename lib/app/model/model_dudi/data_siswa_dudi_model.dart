...
//
//     final dataSiswaDudiModel = dataSiswaDudiModelFromJson(jsonString);

import 'dart:convert';

DataSiswaDudiModel dataSiswaDudiModelFromJson(String str) => DataSiswaDudiModel.fromJson(json.decode(str));

String dataSiswaDudiModelToJson(DataSiswaDudiModel data) => json.encode(data.toJson());

class DataSiswaDudiModel {
    List<Datum>? data;
    ...
    factory DataSiswaDudiModel.fromJson(Map<String, dynamic> json) => DataSiswaDudiModel(
