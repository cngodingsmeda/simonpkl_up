...
//
//     final detilLaporanHarianDudiModel = detilLaporanHarianDudiModelFromJson(jsonString);

import 'dart:convert';

DetilLaporanHarianDudiModel detilLaporanHarianDudiModelFromJson(String str) => DetilLaporanHarianDudiModel.fromJson(json.decode(str));

String detilLaporanHarianDudiModelToJson(DetilLaporanHarianDudiModel data) => json.encode(data.toJson());

class DetilLaporanHarianDudiModel {
    String? msg;
    Data? data;

    DetilLaporanHarianDudiModel({
        this.msg,
        this.data,
    });

    factory DetilLaporanHarianDudiModel.fromJson(Map<String, dynamic> json) => DetilLaporanHarianDudiModel(
        msg: json["msg"],
