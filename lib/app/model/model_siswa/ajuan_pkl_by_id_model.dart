...
AjuanPklByIdModel ajuanPklByIdModelFromJson(String str) => AjuanPklByIdModel.fromJson(json.decode(str));

String ajuanPklByIdModelToJson(AjuanPklByIdModel data) => json.encode(data.toJson());
...
class AjuanPklByIdModel {
    ...
    factory AjuanPklByIdModel.fromJson(Map<String, dynamic> json) => AjuanPklByIdModel(
        id: json["id"],
        status: json["status"],
