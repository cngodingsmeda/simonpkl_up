...
LastAjuanPklModel lastAjuanPklModelFromJson(String str) =>
    LastAjuanPklModel.fromJson(json.decode(str));

String lastAjuanPklModelToJson(LastAjuanPklModel data) =>
...
class LastAjuanPklModel {
  ...
  factory LastAjuanPklModel.fromJson(Map<String, dynamic> json) =>
      LastAjuanPklModel(
        id: json["id"],
        status: json["status"],
