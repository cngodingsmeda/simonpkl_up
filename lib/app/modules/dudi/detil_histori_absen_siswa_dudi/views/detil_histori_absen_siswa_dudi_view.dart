...
class DetilHistoriAbsenSiswaDudiView
    extends GetView<DetilHistoriAbsenSiswaDudiController> {
  const DetilHistoriAbsenSiswaDudiView({super.key});
  @override
  Widget build(BuildContext context) {
    var controller = Get.put(DetilHistoriAbsenSiswaDudiController());
      ...
      body: Obx(
        () {
          if (controller.isLoading.isTrue) {
            ...
            var absensi = controller.detilAbsen.value?.data;
                          ...
                          Container(
                            ...
                            child: Column(
                              children: [
                                ...
                                buildAbsenTile(arg["jenis"],
                                    controller.detilAbsen.value, controller),
...
Widget buildAbsenTile(String jenis, DetilHistoriAbsenSiswaDudiModel? absensi,
    DetilHistoriAbsenSiswaDudiController controller) {
  String? keterangan = jenis.contains("masuk")
      ? absensi?.data?.keteranganAbsenMasuk?.note
      : absensi?.data?.keteranganAbsenPulang?.note;
