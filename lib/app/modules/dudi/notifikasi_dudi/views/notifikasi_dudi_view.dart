...
import 'package:simon_pkl/app/modules/dudi/detil_notifikasi_dudi/views/detil_notifikasi_dudi_view.dart';

import '../controllers/notifikasi_dudi_controller.dart';

class NotifikasiDudiView extends GetView<NotifikasiDudiController> {
  const NotifikasiDudiView({super.key});
  @override
  Widget build(BuildContext context) {
    var controller = Get.put(NotifikasiDudiController());
    return Scaffold(
