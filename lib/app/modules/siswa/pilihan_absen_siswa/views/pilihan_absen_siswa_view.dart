    ...
    return Scaffold(
      ...
      body: Obx(() {
        if (controller.isLoading.isTrue) {
          ...
          if (PilihanAbsenSiswaController.isWithinRadius.isFalse &&
              controller.belumAdaKoordinat.isFalse) {
            return Padding(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        ElevatedButton(
                          onPressed: () async {
                            PilihanAbsenSiswaController.isWithinRadius.value =
                                true;
                            controller.absenLuarRadius.value = true;
                            if (PilihanAbsenSiswaController
                                .isWithinRadius.isTrue) {
          ...
          } else if (controller.belumAdaKoordinat.isTrue) {
            return Padding(
              padding: const EdgeInsets.symmetric(horizontal: 20),
              child: Center(
                child: Column(
                  ...
                  children: [
                    Text(
                      "Dudi belum menambahkan koordinat untuk absen.",
                      textAlign: TextAlign.center,
                      style: AllMaterial.montSerrat(
                          fontWeight: AllMaterial.fontSemiBold),
                    ),
            ...
            var hariIni = DateFormat('EEEE', 'id_ID')
                .format(DateTime.now())
                .toLowerCase();
            JadwalAbsenSiswa? instansi = controller.jadwalAbsenSiswa.value;

            if (instansi?.data == null || instansi!.data!.isEmpty) {
              return Column(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Center(
                    child: Padding(
                      ...
                      child: Obx(
                        () => Text(
                          AllMaterial.hurufPertama(controller.msgAbsen.value),
                          textAlign: TextAlign.center,
                          style: AllMaterial.montSerrat(
                            fontWeight: AllMaterial.fontMedium,
                          ),
              ...
              if (instansi.data != null && instansi.data!.isNotEmpty) {
                // Temukan data yang harinya cocok dengan hari ini
                final jadwalHariIni = instansi.data!.firstWhere(
                  (jadwal) => jadwal.hari!.toLowerCase() == hariIni,
                  orElse: () => Datum(hari: ""),
                );

                if (jadwalHariIni.hari != "") {
                  // Ambil batas absen masuk dan pulang
                  String batasAbsenMasuk = jadwalHariIni.batasAbsenMasuk ?? "";
                  String batasAbsenPulang =
                      jadwalHariIni.batasAbsenPulang ?? "";

                  print('Batas Absen Masuk: $batasAbsenMasuk');
                  print('Batas Absen Pulang: $batasAbsenPulang');
                              ...
                              FittedBox(
                                ...
                                child: Padding(
                                  padding: const EdgeInsets.symmetric(
                                      horizontal: 20),
                                  child: (jadwalHariIni
                                              .batasAbsenMasuk!.isEmpty ||
                                          jadwalHariIni
                                              .batasAbsenPulang!.isEmpty)
                                      ? Text(
                                    ...
                                    tekan: () {
                                      if (controller.isMasuk.isTrue) {
                                        Get.to(
                                          ...
                                          arguments: {
                                            "status": "masuk",
                                            "diLuarRadius": controller
                                                .absenLuarRadius.value,
                                            "latitude":
                  ...
                  child: Column(
                    ...
                    children: [
                      Center(
                        child: Text(
                          textAlign: TextAlign.center,
                          "Data instansi tidak valid atau kosong.",
                          style: AllMaterial.montSerrat(
                            fontWeight: AllMaterial.fontSemiBold,
                            color: AllMaterial.colorGrey,
                            fontSize: 16,
      ...
      bottomNavigationBar: Obx(() {
        if (controller.isLoading.isFalse &&
            PilihanAbsenSiswaController.isWithinRadius.isTrue &&
            controller.belumAdaKoordinat.isFalse) {
